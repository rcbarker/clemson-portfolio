...
public class Jules extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_jules);
     ...
     * Return Value: None.
     * Purpose: Goes to back to Duke's screen.
     */
     ...
     * Input Argument: view - Necessary to link to button in application.
     * Return Value: None.
     * Purpose: Goes to Shane's screen.
     */
    public void next(View view) {
        /* Link to new intent. */
        Intent intent = new Intent(this, Shane.class);
